...
IMG_SIZE = 160
BEST_H5 = MODELS_DIR / "best_detector_v2.h5"
OUT_TFLITE = MODELS_DIR / "detector_v2_int8.tflite"
OUT_META = MODELS_DIR / "detector_v2_metadata.json"
...
print("Loading best V2 model:", BEST_H5)
